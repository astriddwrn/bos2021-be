...
<body class="font-sans">
    ...
    <div class="w-screen h-screen bg-bgSpace relative">
        ...
        <div class="w-full h-full flex flex-col justify-center items-center relative z-10">
            ...
            <div class="text-center font-extrabold text-3xl text-cWhite">left until BNCC Launching!</div>
            <div class="text-center text-cWhite font-bold text-xl rounded p-2 bg-cLightBlue w-3/12 mt-20 hover:bg-cDarkerLightBlue transition duration-300 ease-in-out cursor-pointergit">Back to Home</div>
        </div>
