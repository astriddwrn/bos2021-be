...
<body class="text-base">
                ...
                <div class="bncc-sec w-full section absolute right-section xl:px-24 px-10 hidden">
                    ...
                    <div class="mt-11">
                        ...
                        <span class="schedule-bdg schedule hidden">
                            ...
                            <div class="mt-11 text-cDarkBlue font-sans font-medium w-100 text-2xl mb-4">Do You Want to Join Our ESports Community?</div>
                            <div class="flex">
                                <span class="radio">
    ...
    <script src="{{url('./js/auth.js')}}?t=202108171846"></script>
</body>
</html>
