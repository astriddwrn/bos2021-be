            <div>
                <div class="w-100 flex flex-row justify-between items-center py-4 px-8 font-bold text-cDarkBlue">
                    ...
                    <a href="{{$region != '' ? route('download_users',['region'=>$region]) : ''}}" class="flex flex-row justify-center items-center bg-cLightBlue hover:bg-cDarkerLightBlue text-cWhite font-semibold rounded px-4 py-2">
